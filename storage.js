...
const DB = {
  ...
  deleteChecklist(id) {
    ...
    try {
      if (typeof CertificateStore !== 'undefined' && CertificateStore.deleteForChecklist) {
        CertificateStore.deleteForChecklist(id).catch(e => console.warn('Certificate photo cleanup failed', e));
      }
    } catch (e) { console.warn('Certificate photo cleanup skipped', e); }
  },
