...
<p style="font-size:11px;color:#667">${esc(T('cert.recordTitle', 'Third-party certificate record'))} — Crane Lifting Assessment. ${esc(T('disc.title', 'This checklist does not replace statutory inspection.'))}</p></body></html>`;
  }
