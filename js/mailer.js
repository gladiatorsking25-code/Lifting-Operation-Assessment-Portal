...
const ChecklistEmail = (function () {
  ...
  const LBL = {
    ...
    footer:      { en: 'Generated by Crane Lifting Assessment — a planning aid. This monthly check does not replace statutory third-party examination.', ar: 'صادر عن تطبيق Crane Lifting Assessment — أداة تخطيط. لا يُغني هذا الفحص الشهري عن الفحص القانوني من جهة خارجية.', ur: 'Crane Lifting Assessment سے تیار شدہ — ایک منصوبہ بندی کا ذریعہ۔ یہ ماہانہ جانچ قانونی تھرڈ پارٹی معائنے کا متبادل نہیں۔', hi: 'Crane Lifting Assessment द्वारा निर्मित — एक नियोजन सहायक। यह मासिक जाँच वैधानिक थर्ड-पार्टी परीक्षण का विकल्प नहीं है।' },
